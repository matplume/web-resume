				...
				<div>
					<Container fluid={true} className="experience-wrapper">
						...
						<Timeline lineColor="#e7cd24" className="custom-line-xp">
							<TimelineEvent
								className="custom-xp-event mb-5"
								title="2012 - 2018 : Reponsable Grands Comptes"
								container="card"
								titleStyle={{ fontWeight: "bold" }}
								style={{ boxShadow: "0 1px 2px rgba(0, 0, 0, 0.1)" }}
								cardHeaderStyle={{
									backgroundColor: "#e7cd24",
									color: "whitesmoke",
									border: "1px solid e7cd24",
								}}
								iconColor="#e7cd24"
								icon={<i class="fa fa-rocket" />}
									...
									<Card className="custom-xp-card">
										<CardBody className="card-xp-body-custom pb-1">
											<CardTitle className="card-custom-title">
												IMIE, Ecole de la filière numérique{" "}
												<span className="custom-xp-city">(Nantes)</span>
											</CardTitle>
											<hr />
											<CardSubtitle className="custom-subtitle mb-3 mt-4">
												2017 - 2018 : Responsable Grands comptes
											</CardSubtitle>
											<CardText>
												<p>Accompagnement dans la GPEC</p>
												<p>
													Gestion des plans de recrutements et de formation
													dédiées
												</p>
												<p>Placement des candidats</p>
											</CardText>
											<CardSubtitle className="custom-subtitle mb-3 mt-4">
												2013 - 2016 : Relations entreprises
											</CardSubtitle>
											<CardText>
							...
							<TimelineEvent
								className="mb-5"
								title="2010 - 2011 : Responsable commercial"
								container="card"
								titleStyle={{ fontWeight: "bold" }}
								style={{ boxShadow: "0 1px 2px rgba(0, 0, 0, 0.1)" }}
								cardHeaderStyle={{
								...
								<div>
									<Card className="custom-xp-card">
										<CardBody className="card-xp-body-custom pb-1">
											<CardTitle className="card-custom-title">
												Image Webdesign{" "}
												<span className="custom-xp-city">(Guérande)</span>
											</CardTitle>
											<hr />
											<CardText>
								...
								<div>
									<Card className="custom-xp-card">
										<CardBody className="card-xp-body-custom pb-1">
											<CardTitle className="card-custom-title">
												Groupe Piana{" "}
												<span className="custom-xp-city">(Paris)</span>
											</CardTitle>
											<hr />
											<CardSubtitle className="custom-subtitle mb-3 mt-4">
												2007 - 2010 : Directeur clientèle
											</CardSubtitle>
											<CardText>
